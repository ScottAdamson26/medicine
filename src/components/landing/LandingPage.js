...
function LandingPage() {
  return (
    <div className="flex flex-col mx-auto min-h-screen max-w-6xl p-2">
      ...
      {/* hero section */}
      <div className="flex flex-col md:flex-row flex-grow items-center justify-center md:justify-between px-5 md:px-10 mt-10 md:mt-0 py-0 md:py-36">
        <div className="text-center md:text-left w-full md:w-auto group">  {/* Added group class here */}
          ...
          <button
            className="px-4 py-2 bg-gradient-to-r from-blue-300 to-cyan-400 rounded-full flex items-center text-white font-medium [text-shadow:_0_1px_5px_rgb(0_0_0_/_20%)] transition-all duration-500 ease-in-out hover:pr-5 mx-auto md:mx-0"
