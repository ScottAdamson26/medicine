  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-75 flex justify-center items-center">
      <div className="bg-gradient-to-r from-purple-200 to-fuchsia-300 p-1 rounded-xl shadow-xl">
        <div className="relative bg-white p-8 rounded-lg shadow-lg z-50 flex flex-col">
          <button
            onClick={onClose}
            className="absolute top-2 left-3 text-gray-300 text-lg hover:text-gray-500 transition-colors duration-200"
